...
function About() {
    return (
        <PageBox>
            ...
            <Paper sx={{ borderRadius: 8, width: "95vw", alignSelf: "center", display: "flex", flexDirection: "column", justifyContent: "space-between", alignItems: "center", margin: "auto", marginTop: 8, marginBottom: 4, padding: 4 }}>
                ...
                <Box width="100%" display="flex" flexDirection="row" justifyContent="left" paddingBottom={4}>
                    ...
                    <ListItem key={1} >
                        ...
                        <Typography variant="h4">Engineer in Bionics | Instituto Politécnico Nacional</Typography>
                    </ListItem>
                    <Typography variant="body1" textAlign="left" paddingX={6} >Combining Biology with tech to design innovative systems</Typography>
                    <ListItem key={2} >
                        <Icon icon="icon-park-outline:dot"/>
                        <Typography variant="h4">Professional Technician in Electronics | Colegio Nacional De Educación Profesional Técnica</Typography>
                    </ListItem>
                ...
                <Box width="100%" display="flex" flexDirection="row" justifyContent="left" paddingBottom={4}>
                    ...
                    <ListItem key={4}>
                        <Icon icon="icon-park-outline:dot"/>
                        <Typography variant="h4">Full Stack Development</Typography>
                    </ListItem>
                    ...
                    <ListItem key={7}>
                        <Icon icon="icon-park-outline:dot"/>
                        <Typography variant="h4">Jack of all trades?</Typography>
                    </ListItem>
                ...
                <Box width="100%" display="flex" flexDirection="row" justifyContent="left" paddingBottom={4}>
                    ...
                    <ListItem key={9}>
                        <Icon icon="icon-park-outline:dot"/>
                        <Typography variant="h4">To be the technical ally who transforms BOLD ideas into reality</Typography>
                    </ListItem>
                    ...
                    <ListItem key={10}>
                        <Icon icon="icon-park-outline:dot"/>
                        <Typography variant="h4">I don't just write code; I build solutions that empower people</Typography>
                    </ListItem>
                    </List>
                </Box>
                <Divider sx={{ borderColor: "#2E91D1", borderWidth: 1, alignSelf:"flex-start", width:"95%", paddingX: 4 }} />
                ...
                <Box width="100%" display="flex" flexDirection="row" justifyContent="left" paddingBottom={4}>
                    ...
                    <ListItem key={12}>
                        <Icon icon="icon-park-outline:dot"/>
                        <Typography variant="h4">To become the goto engineer for visionaries who refue to settle for "good enough"</Typography>
                    </ListItem>
